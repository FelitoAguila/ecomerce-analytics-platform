...
from olist.oltp.seed_helpers import COPY_SPECS, copy_table, load_schema, verify_counts
...
def main() -> None:
    ...
    data_dir = Path(settings.ecommerce_db.data_dir)
    dsn = str(settings.ecommerce_db.dsn)
