# OLTP Schema Decisions

Everything decided (and why) when building `src/oltp/schema.sql` and `src/oltp/seed.py`.
...
*Last updated: Phase 1 (OLTP + seed)*
